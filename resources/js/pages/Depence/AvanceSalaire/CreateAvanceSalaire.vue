    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="" @submit.prevent="soumettre" id="createFormAvanceSalaire">
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label for="InputMontantAvanceSalaire">المبلغ المقدم :</label>
                  <input
                    type="number"
                    class="form-control"
                    ...
                    :class="{
                      'is-invalid': form.errors.montantAvanceSalaire,
                    }"
                  />
                  <span
                    v-if="form.errors.montantAvanceSalaire"
                    class="error invalid-feedback"
                    >{{ form.errors.montantAvanceSalaire }}</span
                  >
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label for="InputMontantSalaire">الراتب</label>
                  <input
                    type="number"
                    class="form-control"
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="InputMontantTotalAvancer">مجموع ما تم تقديمه : </label>
                  <input
                    type="number"
                    class="form-control"
                    ...
                    :class="{
                      'is-invalid': form.errors.montantTotalAvancer,
                    }"
                  />
                  <span
