          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="row">
                  <div class="col-md-1">
                    <Link :href="route('salaire.create')" class="btn btn-success"
                  ...
                  <div class="col-md-2">
                    <select @change="search" v-model="month" class="form-control ml-3">
                      <option value="" selected>شهر الرواتب...</option>
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr v-for="(salaire, index) in props.salaires.data" :key="index">
                      ...
                      <th dir="ltr">
                        {{ salaire.montantJoursTravail.toLocaleString() }} UM
                      </th>
                      ...
                      <td class="d-flex gap-2 text-left">
                        ...
                        <button
                          @click="deleteConfimation(salaire.id)"
