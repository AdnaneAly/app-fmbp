    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">تعديل مصروف</h4>
        </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input
                    ...
                    :class="{
                      'is-invalid': editDepence.messageError.hasOwnProperty('date'),
                    }"
                  />
                  <span
                    v-if="editDepence.messageError.hasOwnProperty('date')"
                    class="error invalid-feedback"
                    >{{ editDepence.messageError.date }}</span
                  >
                </div>
                <div class="form-group">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select
                    class="form-control"
                    style="width: 100%"
                    v-model="editDepence.typedepenceIdDepence"
                  >
                    <option value="" selected="selected">إختر...</option>
                    <option
                ...
                <div class="form-group">
                  ...
                  <input
                    ...
                    :class="{
                      'is-invalid': editDepence.messageError.hasOwnProperty('montant'),
                    }"
                  />
                  <span
                    v-if="editDepence.messageError.hasOwnProperty('montant')"
                    class="error invalid-feedback"
                    >{{ editDepence.messageError.montant }}</span
                  >
                </div>
...
const getDepenceById = () => {
  axios
    ...
    .then((response) => {
      ...
      editDepence.typedepenceIdDepence = response.data.depence.type_depence_id;
      ...
      editDepence.annee = response.data.depence.annee;
    })
    .catch((error) => {
      console.log(error);
    });
