            ...
            <div class="card">
              <div class="card-header">
                <div class="row">
                  ...
                  <div class="col-md-2 ml-2">
                    <select @change="search" v-model="grade_id" class="form-control">
                      <option value="" selected>الرتب...</option>
                      <option
                        v-for="item in props.grades"
                        :value="item.id"
                        :key="item.id"
                      >
                        {{ item.name }}
              ...
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr v-for="employeur in props.employeurs.data" :key="employeur.id">
                      <td>1.</td>
                      ...
                      <td>
                        <span
                          class="badge"
                          :class="
                            employeur.etat === 'active' ? 'bg-success' : 'bg-danger'
                          "
                          >{{ employeur.etat }}</span
                        >
                      </td>
                      ...
                      <td class="d-flex gap-2 text-left">
                        <button
                          @click="openEditEmployeur(employeur.id)"
                        ...
                        <button
                          @click="deleteConfimation(employeur.id)"
