            ...
            <div class="card">
                ...
                <div class="row">
                  <div class="col-md-2">
                    <select @change="search" v-model="boulanger_id" class="form-control">
                      <option value="" selected>المخابز...</option>
                      <option
                  ...
                  <div class="col-md-2">
                    <select @change="search" v-model="month" class="form-control">
                      <option value="" selected>شهر الجباية...</option>
                  ...
                  <div class="col-md-2">
                    <select @change="search" v-model="monthPaye" class="form-control">
                      <option value="" selected>شهر التسديد...</option>
                  ...
                  <div class="col-md-2">
                    <select @change="search" v-model="etatImpot" class="form-control">
                      <option value="" selected>حالة الجباية...</option>
              ...
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr v-for="(recette, index) in props.recettes.data" :key="recette.id">
                      <td>{{ index + 1 }}.</td>
                      <td>
                        ...
                        <span
                          ...
                          :class="
                            recette.type_recette === 'PAYE'
                              ...
                              : recette.type_recette === 'SEMIPAYE'
                              ? 'bg-warning'
                              : recette.type_recette === 'FERMER'
                              ? 'bg-secondary'
                              : recette.type_recette === 'EXONERER'
                              ? 'bg-info'
                              : 'bg-danger'
                          "
                          >{{ etatImpotAR[recette.type_recette] }}</span
                        >
                      </td>
                      <th dir="ltr">
                      ...
                      <td class="d-flex gap-2 text-left">
                        <button
                          @click="openEditRecette(recette.id)"
                        ...
                        <button
                          @click="deleteConfimation(recette.id)"
