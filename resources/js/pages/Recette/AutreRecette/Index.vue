            ...
            <div class="card">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <select
                      ...
                      class="form-control"
                    >
                      <option value="" selected>انواع المداخيل...</option>
                      <option
                  ...
                  <div class="col-md-2">
                    <select @change="search" v-model="month" class="form-control">
                      <option value="" selected>شهر الدخل...</option>
              ...
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr
                      v-for="(autrerecette, index) in props.autrerecettes.data"
                      :key="autrerecette.id"
                    >
                      <td>{{ index + 1 }}.</td>
                      <td>
                      ...
                      <td class="d-flex gap-2 text-left">
                        ...
                        <button
                          @click="deleteConfimation(autrerecette.id)"
