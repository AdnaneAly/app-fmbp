                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        :class="{
                                            'is-invalid':
                                                editBoulanger.messageError.hasOwnProperty('name'),
                                        }"
                                    />
                                    <span
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        :class="{
                                            'is-invalid':
                                                editBoulanger.messageError.hasOwnProperty('proprietaire_id'),
                                        }"
                                    >
                                    <option v-for="item in props.proprietaires" :value="item.id" :key="item.id" >{{ item.name }}</option>
                                    </select>
                                    <span
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        :class="{
                                            'is-invalid':
                                                editBoulanger.messageError.hasOwnProperty('address'),
                                        }"
                                    />
                                    <span
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        :class="{
                                            'is-invalid':
                                                editBoulanger.messageError.hasOwnProperty('etat'),
                                        }"
                                    >
